...
name: crm-cleanup
description: >-
  CRM hygiene sweep methodology: stale records, duplicate contacts, missing fields; owner approves fixes. Written for HubSpot. There is no CRM project in this system; apply the METHOD to vault/people when auditing who you know and what is stale. Use when cleaning or auditing contact data.
