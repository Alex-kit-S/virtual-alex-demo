...
description: >-
  Optimize CV content for Applicant Tracking Systems: compatibility, keyword match, screening survival. Use when tailoring a CV or when ATS/parsing is mentioned. Distinct from resume-builder (Reactive Resume JSON generator).
---
