...
description: >-
  Keep the CRM current from email and calendar context: create/update contacts, log interactions, flag stale records. Written for HubSpot. There is no CRM project in this system; apply the METHOD to vault/people. Use when filing relationship context after a meeting or a mail.
---
